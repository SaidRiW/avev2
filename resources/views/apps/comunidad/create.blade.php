        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="panel p-8 rounded-lg overflow-hidden w-full max-w-md">
                <div class="flex justify-between items-center mb-4 dark:text-white">
                    <h2 class="text-xl font-semibold">{{ _('Nueva publicación') }}</h2>
                ...
                <!-- Form -->
                <form class="flex flex-col gap-4" action="{{route('apps.comunidad.store')}}" method="POST" tabindex="-1" role="dialog" enctype="multipart/form-data">
                @csrf  
                    <div class="relative">
                    ...
                    <a href="#" id="toggleDateFields" class="text-primary underline">Si esta publicación es un evento, clic aquí.</a>

                    <!-- Campos de fechas que se muestran al dar click al enlace -->
                    <div id="dateFields" style="display: none;">
                        <div class="relative mb-4" x-data="form">
                            <label for="fechaInicio">Fecha inicial</label>
                            <input id="fechaInicio" name="fechaInicio" class="form-input" />
                        </div>
                        <div class="relative mb-4" x-data="form">
                            <label for="fechaFin">Fecha final</label>
                            <input id="fechaFin" name="fechaFin" class="form-input" />
                        </div>
                    </div>
