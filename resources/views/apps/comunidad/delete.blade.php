        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="panel p-8 rounded-lg overflow-hidden w-full max-w-md">
                <div class="flex justify-between items-center mb-4 dark:text-white">
                    <h2 class="text-xl font-semibold">¿Estás seguro de eliminar esta publicación?</h2>
                </div>
                ...
                <form id="deleteForm" method="POST" action="">
                    ...
                    <div class="relative mb-4">
                        <input type="text" class="form-input disabled:pointer-events-none disabled:bg-[#eee] dark:disabled:bg-[#1b2e4b] cursor-not-allowed" disabled name="titulo" class="form-input">
                    </div>
