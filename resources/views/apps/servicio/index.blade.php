<x-layout.default>
    ...
    @include('apps.servicio.create')
    @include('apps.servicio.edit')
    @include('apps.servicio.delete')
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("striped", () => ({
                init() {
                    const tableOptions = {
                        data: {
                            headings: ["#", "Nombre", "Fecha de creación", "Fecha de modificación", "Acciones"],
                            data: [
                                @php
                                    $cont = 1 ;  
                                @endphp       
                    ...
                    function showModalEdit(id, nombre) {
                        const modalEdit = document.getElementById('modalEdit');
                        const editForm = document.getElementById('editForm');
                        editForm.action = '/apps/servicio/' + id;
                    ...
                    function showModalDelete(id, nombre) {
                        ...
                        deleteForm.action = '/apps/servicio/' + id;
                    ...
                    editButtons.forEach(button => {
                        button.addEventListener('click', function () {
                            const id = this.dataset.id; // Obtener el ID del servicio
                            const nombre = this.parentNode.parentNode.querySelector('td:nth-child(2)').textContent.trim(); // Obtener el nombre del servicio
