<x-layout.default>
    ...
    @include('apps.carrera.create')
    @include('apps.carrera.edit')
    @include('apps.carrera.delete')
    <script>
            ...
            Alpine.data("striped", () => ({
                init() {
                    ...
                    function showModalEdit(id, nombre) {
                        ...
                        editForm.action = '/apps/carrera/' + id;
                    ...
                    function showModalDelete(id, nombre) {
                        ...
                        deleteForm.action = '/apps/carrera/' + id;
                    ...
                    editButtons.forEach(button => {
                        button.addEventListener('click', function () {
                            const id = this.dataset.id; // Obtener el ID de la carrera
                            const nombre = this.parentNode.parentNode.querySelector('td:nth-child(2)').textContent.trim(); // Obtener el nombre de la carrera
