<x-layout.default>
    ...
    @include('apps.evento.edit')
    @include('apps.evento.delete')
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("striped", () => ({
                init() {
                    const tableOptions = {
                        data: {
                            headings: ["#", "Título", "Descripción", "Fecha/Hora", "Prioridad", "Acciones"],
                            data: [
                                @php
                                    $cont = 1 ;  
                                @endphp       
                    ...
                    function showModalEdit(id, titulo, descripcion, fecha_hora) {
                        const modalEdit = document.getElementById('modalEdit');
                        const editForm = document.getElementById('editForm');
                        editForm.action = '/apps/evento/' + id;
                    ...
                    function showModalDelete(id, titulo) {
                        ...
                        deleteForm.action = '/apps/evento/' + id;
                    ...
                    editButtons.forEach(button => {
                        button.addEventListener('click', function () {
                            ...
                            showModalEdit(id, titulo, descripcion, fecha_hora);
                        });
                    });
