...
<head>
    ...
    <title>{{ $title ?? 'Agenda Virtual Escolar' }}</title>
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased collapsible-vertical full ltr"
    ...
    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">
        ...
        <div class="main-content flex flex-col min-h-screen">
            ...
            <div class="px-6 py-5 animate__animated" :class="[$store.app.animation]">
                {{ $slot }}
